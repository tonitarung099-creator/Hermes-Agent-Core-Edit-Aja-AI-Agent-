...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("quiet", "Toggle Edit Aja Telegram quiet mode", "Configuration",
               gateway_only=True, args_hint="[on|off|status]", subcommands=("on", "off", "status"),
               busy_policy="dispatch", desktop="hidden"),
    ...
    CommandDef("debug", "Edit Aja debug display on/off, or upload a debug report", "Info",
               args_hint="[on|off|status|nous|local]",
               subcommands=("on", "off", "status", "nous", "local")),

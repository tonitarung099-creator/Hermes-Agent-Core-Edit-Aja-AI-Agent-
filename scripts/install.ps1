...
$RepoUrlSsh = "git@github.com:tonitarung099-creator/Hermes-Agent-Core-Edit-Aja-AI-Agent-.git"
$RepoUrlHttps = "https://github.com/tonitarung099-creator/Hermes-Agent-Core-Edit-Aja-AI-Agent-.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/tonitarung099-creator/Hermes-Agent-Core-Edit-Aja-AI-Agent-/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/tonitarung099-creator/Hermes-Agent-Core-Edit-Aja-AI-Agent-/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/tonitarung099-creator/Hermes-Agent-Core-Edit-Aja-AI-Agent-/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
